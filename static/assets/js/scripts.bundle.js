...
KTUtil.ready(function() {
    ...
    if (typeof KTLayoutQuickPanel !== 'undefined') {
        ...
        if (typeof AccountSettings !== 'undefined') {
            AccountSettings.init('account_settings');
        }
...
var KTLayoutQuickPanel = function() {
    ...
    var _personalElement;
    var _providerElement;
    ...
    var _initPersonal = function() {
        KTUtil.scrollInit(_personalElement, {
            mobileNativeScroll: true,
            resetHeightOnDestroy: true,
            handleWindowResize: true,
            height: function() {
    ...
    var _initProvider = function() {
        KTUtil.scrollInit(_providerElement, {
            mobileNativeScroll: true,
            resetHeightOnDestroy: true,
            handleWindowResize: true,
            height: function() {
    ...
    var _updateScrollbars = function() {
        $(_element).find('a[data-toggle="tab"]').on('shown.bs.tab', function (e) {
            ...
            KTUtil.scrollUpdate(_personalElement);
            KTUtil.scrollUpdate(_providerElement);
        });
    }
    ...
    return {
        init: function(id) {
            ...
            _personalElement = KTUtil.getById('kt_quick_panel_personal_settings');
            _providerElement = KTUtil.getById('kt_quick_panel_provider_settings');
